  ...
  <div class=" navbar-collapse justify-content-end inner-header" id="collapsibleNavbar">
    <ul class="navbar-nav" style="float: right;">
      ...
      <li class="nav-item cart-icon">
        ...
        <a class="nav-link btn btn-light text-dark" href="{{ url('List-Carts') }}"><i class="fas fa-cart-arrow-down"></i>
          <b>Giỏ hàng</b>
...
<div class="container-fluid fixed-top " style="margin-top: 58px; z-index: -1; position: absolute;">
  ...
  <nav class="navbar hr  ">
    <a class="nav-link btn btn-dark " href="{{route('home')}}"> <i class="fas fa-home"></i> Trang chủ</a>
    <a class="nav-link text-dark" href="{{ route('gioithieu') }}"><i class="far fa-hand-point-right"></i> Giới thiệu</a>

    <li class="nav-item dropdown">
      <a class="nav-link text-dark" href="#" id="navbarDropdown"><i class="fas fa-bars"></i> Sản phẩm</a>
    ...
    <li class="nav-item dropdown">
      <a class="nav-link text-dark" href="#"><i class="fas fa-headset"> </i> Liên hệ</a>
      <div class="dropdown-content">
        <a class="dropdown-item" href="https://www.messenger.com/t/100006384005664">Chat với tư vấn mua hàng</a>
        <h6 class="dropdown-item" href="">CSKH: <a href="" class="btn-outline-info">0328715234</a> <i
