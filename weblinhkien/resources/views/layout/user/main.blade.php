...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/frontend/style1.css') }}">
    <link rel="stylesheet" href="{{ asset("public/frontend/bootstrap-4.0.0-dist/css/bootstrap1.css") }}">
...
<link rel="stylesheet" href="{{ asset('public/frontend/swiper/css/style.css') }}">
    ...
    <title>Website Bán Linh Kiện Máy Tính</title>
    <style>
      .well{
        min-height: 20px;
                padding: 19px;
